...
export default function Login() {
  ...
  return (
    <div className="relative ">
      ...
      <div class="w-full px-3 mx-auto pt-44 md:flex-0 shrink-0 absolute top-0 left-0 right-0 bottom-0">
  <div class="relative z-0 flex flex-col min-w-0 break-words bg-white border-0 shadow-soft-xl rounded-2xl bg-clip-border lg:w-[40%] mx-auto">
