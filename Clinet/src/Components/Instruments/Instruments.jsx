...
export default function Instruments() {
  return (
    <div className="my-[15%]">
        <Title title={"Musical Instruments"} semititle={"classes"}></Title>
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-5 w-full py-16 ">
        {musicalInstruments.map((instrument) => (
          <div
            className="text-center w-48 mx-auto lg:mt-0 mt-10"
